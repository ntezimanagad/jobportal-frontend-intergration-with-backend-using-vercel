...
function Register() {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      setLoading(true);
      await axios.post(
        `https://spring-boot-jobportal-system-devops-2.onrender.com/api/auth/register`,
        {
          name,
          email,
          password,
  ...
  const handleRegisterValidation = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(
        `https://spring-boot-jobportal-system-devops-2.onrender.com/api/auth/confirm-registration?otpCode=${otpCode}`,
        { name, email, password, role: roles }
      );
